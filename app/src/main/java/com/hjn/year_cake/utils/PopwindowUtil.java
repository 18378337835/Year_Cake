...
/**
 * Created by Year_Cake on 2018/9/3.
 * popwindow工具类
 */

public abstract class PopwindowUtil {
     ...
     */
    public PopwindowUtil(Context context, int layoutResId, int stytle, int width, int height, View view, int gravity, int x, int y, ClickListener callback) {
        ...
        PopBuilder builder = PopBuilder.createPopupWindow(context, layoutResId, stytle,width, height, view, gravity, x, y, mCallback);
    }
    ...
    public static class PopBuilder {
        ...
        public static PopBuilder createPopupWindow(final Context context, int layoutResId, int stytle, int width, int height, View parent, int gravity, int x, int y, ClickListener callback) {
            ...
            window.setAnimationStyle(stytle);
