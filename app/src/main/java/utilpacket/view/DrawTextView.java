...
public class DrawTextView extends AppCompatTextView {
    ...
    private void initAttrs(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray =
                    getContext().obtainStyledAttributes(attrs, R.styleable.DrawTextView);
            corner = typedArray.getDimension(R.styleable.DrawTextView_corner, DEFAULT_CORNER);
            leftTopCornerEnable =
                    typedArray.getBoolean(R.styleable.DrawTextView_left_top_corner, false);
            rightTopCornerEnable =
                    typedArray.getBoolean(R.styleable.DrawTextView_right_top_corner, false);
            leftBottomCornerEnable =
                    typedArray.getBoolean(R.styleable.DrawTextView_left_bottom_corner, false);
            rightBottomCornerEnable =
                    typedArray.getBoolean(R.styleable.DrawTextView_right_bottom_corner, false);
            solid = typedArray.getColor(R.styleable.DrawTextView_solid, DEFAULT_SOLID);
            strokeWidth = typedArray.getDimension(R.styleable.DrawTextView_stroke_width,
                    DEFAULT_STROKE_WIDTH);
            strokeColor =
                    typedArray.getColor(R.styleable.DrawTextView_stroke_color, DEFAULT_STROKE_COLOR);
            drawable = typedArray.getDrawable(R.styleable.DrawTextView_state_drawable);
            drawableWidth =
                    typedArray.getDimension(R.styleable.DrawTextView_state_drawable_width, 0);
            drawableHeight =
                    typedArray.getDimension(R.styleable.DrawTextView_state_drawable_height, 0);
            drawablePaddingLeft =
                    typedArray.getDimension(R.styleable.DrawTextView_state_drawable_padding_left, 0);
            drawablePaddingTop =
                    typedArray.getDimension(R.styleable.DrawTextView_state_drawable_padding_top, 0);
            isShowState = typedArray.getBoolean(R.styleable.DrawTextView_isShowState, false);
            stateDrawableMode = typedArray.getInteger(R.styleable.DrawTextView_state_drawable_mode,
                    DEFAULT_STATE_DRAWABLE_MODE);
            textStroke = typedArray.getBoolean(R.styleable.DrawTextView_text_stroke, false);
            textStrokeColor = typedArray.getColor(R.styleable.DrawTextView_text_stroke_color,
                    DEFAULT_TEXT_STROKE_COLOR);
            textFillColor = typedArray.getColor(R.styleable.DrawTextView_text_fill_color,
                    DEFAULT_TEXT_FILL_COLOR);
            textStrokeWidth = typedArray.getDimension(R.styleable.DrawTextView_text_stroke_width,
                    DEFAULT_TEXT_STROKE_WIDTH);
            autoAdjust = typedArray.getBoolean(R.styleable.DrawTextView_autoAdjust, false);
            shaderStartColor =
                    typedArray.getColor(R.styleable.DrawTextView_shaderStartColor, 0);
            shaderEndColor =
                    typedArray.getColor(R.styleable.DrawTextView_shaderEndColor, 0);
            shaderMode = typedArray.getInteger(R.styleable.DrawTextView_shaderMode, 0);
            shaderEnable = typedArray.getBoolean(R.styleable.DrawTextView_shaderEnable, false);
            typedArray.recycle();
        }
    }
     ...
     */
    public DrawTextView setCorner(float corner) {
        this.corner = corner;
        postInvalidate();
     ...
     * @return SuperTextView
     */
    public DrawTextView setSolid(int solid) {
        this.solid = solid;
        postInvalidate();
     ...
     * @return SuperTextView
     */
    public DrawTextView setStrokeWidth(float strokeWidth) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setStrokeColor(int strokeColor) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setAdjuster(Adjuster adjuster) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setTextStroke(boolean textStroke) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setTextStrokeColor(int textStrokeColor) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setTextFillColor(int textFillColor) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setTextStrokeWidth(float textStrokeWidth) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setAutoAdjust(boolean autoAdjust) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setLeftTopCornerEnable(boolean leftTopCornerEnable) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setRightTopCornerEnable(boolean rightTopCornerEnable) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setLeftBottomCornerEnable(boolean leftBottomCornerEnable) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setRightBottomCornerEnable(boolean rightBottomCornerEnable) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setDrawable(Drawable drawable) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setDrawable(int drawableRes) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setShowState(boolean showState) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setStateDrawableMode(int stateDrawableMode) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setDrawableWidth(float drawableWidth) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setDrawableHeight(float drawableHeight) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setDrawablePaddingLeft(float drawablePaddingLeft) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setDrawablePaddingTop(float drawablePaddingTop) {
    ...
    /**
     * @param shaderStartColor 设置渐变起始色。需要调用{@link DrawTextView#setShaderEnable(boolean)}后才能生效。会触发一次重绘。
     * @return SuperTextView
     */
    public DrawTextView setShaderStartColor(int shaderStartColor) {
    ...
    /**
     * @param shaderEndColor 设置渐变结束色。需要调用{@link DrawTextView#setShaderEnable(boolean)}后才能生效。会触发一次重绘。
     * @return SuperTextView
     */
    public DrawTextView setShaderEndColor(int shaderEndColor) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setShaderMode(int shaderMode) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setShaderEnable(boolean shaderEnable) {
     ...
     * @return SuperTextView
     */
    public DrawTextView setFrameRate(int frameRate) {
        if (frameRate > 0) {
    ...
    /**
     * 启动动画。需要设置{@link DrawTextView#setAutoAdjust(boolean)}为true才能看到。
     */
    ...
    public static abstract class Adjuster {
         ...
         */
        protected abstract void adjust(DrawTextView v, Canvas canvas);
         ...
         */
        public boolean onTouch(DrawTextView v, MotionEvent event) {
            return false;
        };
    ...
    public static class DefaultAdjuster extends Adjuster {
        ...
        @Override
        public void adjust(DrawTextView v, Canvas canvas) {
            int length = v.length();
