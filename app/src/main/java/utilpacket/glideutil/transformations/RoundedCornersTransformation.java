...
import utilpacket.utils.DensityUtils;
...
public class RoundedCornersTransformation extends BitmapTransformation {
  ...
  private static final String ID = BuildConfig.APPLICATION_ID+"RoundedCornersTransformation." + VERSION;
  ...
  public RoundedCornersTransformation(Context context, float radius, CornerType cornerType) {
    super();
    mRadius = DensityUtils.dp2px(context, radius);
