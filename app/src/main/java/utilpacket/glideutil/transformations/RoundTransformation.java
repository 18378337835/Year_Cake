...
public class RoundTransformation extends BitmapTransformation {
    ...
    private static final String ID = BuildConfig.APPLICATION_ID+"RoundTransformation." +
            VERSION;
    private static final byte[] ID_BYTES = ID.getBytes(CHARSET);

    public RoundTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public RoundTransformation(BitmapPool pool, int radius, int margin) {
        this(pool, radius, margin, CornerType.ALL);
    }

    public RoundTransformation(Context context, int radius, int margin,
                                        CornerType cornerType) {
        this(GlideApp.get(context).getBitmapPool(), radius, margin, cornerType);
    }
